...
I've [written recently](/2008/07/01/hybrid-storage-pools-in-cacm/) about the hybrid storage pool (HSP), using ZFS to augment the conventional storage stack with flash memory. The resulting system improve performance, cost, density, capacity, power dissipation — pretty much evey axis of importance.
