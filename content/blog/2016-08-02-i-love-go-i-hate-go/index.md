...
One of the things that turned me off of C++ (98, 11, and 14) is its increasing amount of magic. Go is comparatively straightforward. When I reach for something I find that it's where I expect it to be. Libraries and examples aren’t mysterious. Error messages are non-mysterious (other than quickly resolved confusion about methods with “[pointer receivers](http://stackoverflow.com/questions/33936081/golang-method-with-pointer-receiver)”). Contrast this with [Rust whose errors read like mind-bindingly inscrutable tax forms](/2015/06/22/first-rust-program-pain/).
