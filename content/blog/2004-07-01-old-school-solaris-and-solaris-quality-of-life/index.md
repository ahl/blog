...
In Solaris 9, I implemented a `\-p` flag that lets users apply `nohup(1)` to a live running process. And if you've never run `nohup(1)` you might not care, but if you have, you know how useful this is. Solaris is full of these kind of quality of life tools. Check out all of the p-tools which [Eric Schrock](http://eschrock.dtrace.org/) has been writing about.
