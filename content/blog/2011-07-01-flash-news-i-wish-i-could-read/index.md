...
An Aggregate is the term NetApp uses for a collection of drives. A Hybrid Aggregate — presumably — is some new thing that mixes HDDs and SSDs. Maybe it's like Sun's [hybrid storage pool](/2008/07/01/hybrid-storage-pools-in-cacm/). I would have liked to see Manish Goel's statement vetted or explained, but that's all we get.
