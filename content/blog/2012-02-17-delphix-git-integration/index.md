...
[![](images/delphix_git-300x225.jpg "delphix_git")](/resources/delphix_git.pdf)
...
Git is a powerful tool generally, but in particular has some powerful hook points that we use to enforce our code integration criteria and to do some handy things after we integrate. For this, we wrote some custom bash scripts, and python integrations with Bugzilla and Review Board. You can check out the [slides](/resources/delphix_git.pdf), and we've open sourced it all on [github](https://github.com/delphix/git-hooks) with the hope that it might help people with their own integrations.
